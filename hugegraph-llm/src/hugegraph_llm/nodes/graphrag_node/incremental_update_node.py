...
class IncrementalUpdateNode(BaseNode):
    """
    Node for incremental graph updates.

    Appends new entities/edges to the existing graph without
    full rebuild. Performs deduplication and property merging.
    """
    ...
    def operator_schedule(self, data_json: Dict[str, Any]) -> Dict[str, Any]:
        return self.updater.run(data_json)
