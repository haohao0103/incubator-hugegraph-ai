...
CAPABILITY_MATRIX = [
    ...
    ("Index", "Incremental Index Update", "Tab 7", "Partial", "P0", "Only status shown"),
    ...
    ("Graph", "Synonym Manager", "None", "Missing", "P1", "Graph quality enhancement"),
    ("Graph", "Chunk Similarity Edges", "None", "Missing", "P1", "Chunk-level graph edges"),
    ("LLM", "Info Extract (Triples)", "Tab 1", "Exposed", "-", "Standard KG extraction"),
    ("LLM", "Property Graph Extract", "None", "Missing", "P0", "Rich property extraction"),
    ...
    ("LLM", "Gremlin Validator", "None", "Missing", "P1", "Self-correcting Text2Gremlin"),
    ...
    ("Multimodal", "Multimodal KG Builder", "None", "Missing", "P0", "Image/PDF → KG"),
    ("Multimodal", "Multimodal Retriever", "None", "Missing", "P0", "Image-text retrieval"),
    ("Multimodal", "PDF/Image Extractor", "None", "Missing", "P0", "VLM-based extraction"),
    ("Multimodal", "VLM Descriptor", "None", "Missing", "P0", "Visual description"),
    ...
    ("Agent", "Query Classifier", "None", "Missing", "P1", "Intent routing"),
